    ...
    .settings-wrapper {
      ...
      .wrapper {
        ...
        .toggle-button {
          ...
          background-color: var(--color-nav-txt);
          box-shadow:
            1px 2px 1px -1px rgba(173, 173, 173, 0.637),
            inset 1px 1px 1px 1px rgba(245, 245, 245, 0.267),
            inset 2px 2px 0px 1px rgba(239, 240, 240, 0.123);
          transition:
        ...
        .toggle-checkbox:checked ~ .toggle-slot .toggle-button {
          ...
          box-shadow:
            ...
            inset 1px 1px 1px 1px rgba(150, 150, 150, 0.089),
            inset 2px 2px 0px 1px rgba(239, 240, 240, 0.123);
