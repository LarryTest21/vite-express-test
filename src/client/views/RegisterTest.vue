...
const register = () => {
    ...
    if (
        ...
        axios.post(POST_URL, info).then((response) => {
            ...
            console.log(params);
            emailjs.send('service_p58jq8o', 'template_98lmab7', params, 'qgnn9s4h0TIn48Qgw').then(function (response) {
            ...
            <transition name="modal">
                <div class="modal-wrapper" v-if="modalActivation">
                    <Modal :modalLoadingMessage="modalLoadingMessage" :modalAnimation="modalAnimation" :fontSize="'2rem'"
                        :spinnerColor="'var(--color-nav-txt)'" :position="'absolute'" class="modal" :backgroundOpacity="0.9"
