...
const mainCategoryEvent =["Tournament", "Cup", "Training", "Disclaimer"]
const postSaved = () => {
        ...
        <div class="buttons-editor">
          <div class="post-title-wrapper">
            <div class="post-title">
              <label v-text="currentRouteName == 'createpost' ? 'Post Title' : 'Event Title'"
              ></label>
              <input class="post-title" v-model="postTitle" />
            </div>

            <div class="selection-wrapper">
              <label for="category" v-text="currentRouteName == 'createpost' ? 'Post Category' : 'Type of Event'"></label>
              <MultiSelect :multiSelectOptions="mainCategoryEvent" v-if="currentRouteName === 'createevent'"
                  :fontSize="'1.5rem'"
                ...
                />
              <div class="selects">
                <MultiSelect :multiSelectOptions="mainCategory" v-if="currentRouteName === 'createpost'"
                  :fontSize="'1.5rem'"
                  :savedValue="savedMainCategory"
                  :deleteAble="false"
                  @mainCategory="mainCategoryEmit"
